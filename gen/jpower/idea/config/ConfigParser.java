...
import static jpower.idea.config.psi.ConfigTypes.*;

@SuppressWarnings({"SimplifiableIfStatement", "UnusedAssignment"})
public class ConfigParser implements PsiParser {

    public static final Logger LOG_ = Logger.getInstance("jpower.idea.config.ConfigParser");
